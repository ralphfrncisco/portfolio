...
import { FolderCode, X, ExternalLink, Github, ChevronLeft, ChevronRight } from 'lucide-react'
                        ...
                        <div className="flex flex-col mt-4 space-y-4">
                            {projects.map((project, index) => (
                                <div
                                    ...
                                    className="flex flex-col md:flex-row items-center gap-4 p-4 rounded-md transition-colors duration-300 cursor-pointer
                                        bg-gray-50 border border-gray-100 text-gray-900 hover:border-gray-300 hover:bg-gray-100/60
                                        dark:bg-black/40 dark:border dark:border-white/5 dark:text-white dark:hover:border-white/15 dark:hover:bg-white/5"
                                >
                                    <div>
                                        <img
                                            src={project.path}
                                        ...
                                        <div className="flex flex-col md:flex-row md:items-center justify-start md:justify-between gap-2">
                                            ...
                                            <div className="flex flex-wrap items-center gap-1.5 text-[10px] md:text-xs font-mono">
                                                <div className="px-2.5 py-0.5 rounded-full truncate
                                                    text-gray-800 bg-gray-300/50 font-normal
                                                    dark:text-white/80 dark:bg-[#1E1E1E] dark:border dark:border-white/10">
                                                    <p>{project.type}</p>
                                                </div>
                                                <div className="px-2.5 py-0.5 rounded-full truncate
                                                    text-gray-800 bg-gray-300/50 font-normal
