...
function TechStack({darkMode}) {
    ...
    const ImageLanguages = [
        { name: "Python", path: "/src/assets/images/languages/python.png", size: "h-4 w-4", category: "Systems" },
        { name: "Java", path: "/src/assets/images/languages/java.png", size: "h-5 w-5", category: "Systems" },
        { name: "SQL", path: "/src/assets/images/languages/mysql1.png", size: "h-5 w-5", category: "Web" },
        { name: "C#", path: "/src/assets/images/languages/csharp.png", size: "h-4 w-4", category: "Systems" },
        { name: "C++", path: "/src/assets/images/languages/C++.png", size: "h-4 w-4", category: "Systems" },
        { name: "BootStrap", path: "/src/assets/images/languages/bootstrap.png", size: "h-4 w-5", category: "Web" },
        { name: "PHP", path: "/src/assets/images/languages/php.png", size: "h-4 w-7", category: "Web" },
        { name: "Tailwind CSS", path: "/src/assets/images/languages/tailwind.png", size: "h-4 w-6", category: "Web" },
        { name: "React", path: "/src/assets/images/languages/React-icon.png", size: "h-5 w-6", category: "Web" },
    ];
    ...
    const ImageTools = [
        ...
        { name: "XAMPP", path: "/src/assets/images/tools/xamp.png", size: "h-5 w-5", category: "DevTools" },
        { name: "Photoshop", path: "/src/assets/images/tools/photoshop.png", size: "h-5 w-5", category: "Design" },
        ...
        { name: "Gemini", path: "/src/assets/images/tools/gemini.png", size: "h-5 w-5", category: "AI" },
        { name: "Copilot", path: "/src/assets/images/tools/copilot.png", size: "h-5 w-5", category: "AI" },
    ];
