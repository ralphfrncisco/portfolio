...
function TechStack({ darkMode }) {
    ...
    const modalJSX = (
        <div className="fixed inset-0 z-[9999] flex items-center justify-center p-4 bg-black/70">
            <div className={`w-full max-w-2xl rounded-xl p-6 shadow-2xl transition-all ${
                darkMode ? 'bg-[#121212] text-white border border-[#333]' : 'bg-white text-gray-900 border border-gray-200'
            }`}>
                <div className="flex items-center justify-between mb-8">
                    ...
                    <button onClick={() => setIsModalOpen(false)} className="cursor-pointer hover:bg-gray-500/20 p-2 rounded-full transition-colors">
                        <X size={20} />
                    </button>
                </div>
    ...
    return (
        <section className="p-2">
            ...
            {isModalOpen && createPortal(modalJSX, document.getElementById('portal-root'))}
        </section>
    );
}
